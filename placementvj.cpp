[16:10, 3/21/2021] Vijay: #include "mainwindow.h"
...
{
    QMessageBox::StandardButton reply= QMessageBox::information(this,"VIJAYARANGAN","212218107010 SUCCESSFULLY COMPLETED");
}
